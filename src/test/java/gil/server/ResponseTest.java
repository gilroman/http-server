...
public class ResponseTest {
    ...
    @Test
    public void shouldAllowSettingHTTPProtocol() throws UnsupportedEncodingException {
    ...
    @Test
    public void shouldAllowSettingHTTPStatusCode() throws UnsupportedEncodingException {
        Response response = new Response();
    ...
    @Test
    public void shouldAllowSettingReasonPhrase() throws UnsupportedEncodingException {
        Response response = new Response();
    ...
    @Test
    public void shouldHaveAStartLine() throws UnsupportedEncodingException {
        Response response = new Response();
    ...
    @Test
    public void shouldHaveADateHeader() throws UnsupportedEncodingException {
        Response response = new Response();
    ...
    @Test
    public void shouldAllowSettingContentType() throws UnsupportedEncodingException {
        Response response = new Response();
