...
public class PeopleDataTest {
    ...
    @Test
    public void shouldAddAPerson() throws IOException {
    ...
    @Test
    public void shouldAddMultiplePersons() throws IOException {
        PeopleData peopleData = new PeopleData();
    ...
    @Test
    public void shouldConvertAStringRepresentingAPersonToAJsonObject() throws IOException {
        PeopleData peopleData = new PeopleData();
